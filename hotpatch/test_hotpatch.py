...
class HotpatchTestCase(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.hotCommand = HotpatchCommand(self.cli)
    ...
    def test_operate_hot_patches_when_func_return_fail(self):
        ...
        self.assertIsNone(self.hotCommand.operate_hot_patches(target_patch, operate, func))
        func.assert_called_once_with(target_patch[0])
        self.assertEqual(self.hotCommand.base.output.term.bold.call_args_list[1][0][0],
                         target_patch[0])
