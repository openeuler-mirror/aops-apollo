...
def generate_advisory(args) -> Element:
    ...
    references = generate_references(args.reference_type,
                                     args.reference_id,
                                     args.reference_href)
...
def main():
    ...
    # required parameters
    parser.add_argument('update_type', type=str, choices=['security', 'bugfix', 'enhancement'],
                        help='(security/bugfix/enhancement)')
    parser.add_argument('title', type=str)
    parser.add_argument('id', type=str)
    parser.add_argument('--reference-type', type=str, required=True, choices=['cve', 'bugfix', 'feature'],
                        help='(cve/bugfix/feature)')
    ...
    parser.add_argument('--severity', type=str, choices=['Critical', 'Important', 'Moderate', 'Low'],
                        help='(Critical/Important/Moderate/Low)', required=False)
    parser.add_argument('--reference-href', type=str, nargs='+', required=False, help='(Corresponding to \
                        the reference-id)')
    ...
    # package directory
    parser.add_argument('--package-dir', type=str, required=True, help='(Collect rpm package information from \
                        the package directory.)')
    # input path
    parser.add_argument('-i', '--input-path', type=str, required=False, help='(If input path is not none, the \
                        new advisory will be appended and written to the output path.)')
    # output path
    parser.add_argument('-o', '--output-path', type=str, default='./updateinfo.xml', required=False, help='\
