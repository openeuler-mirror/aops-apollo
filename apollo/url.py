...
SPECIFIC_URLS = {
    ...
    "CVE_TASK_URLS": [
        ...
        (cve_task_view.VulGenerateHotpatchDeactivate, VUL_TASK_HOTPATCH_DEACTIVATE_GENERATE),
    ...
    "CVE_TASK_CALLBACK_URLS": [
        ...
        (cve_task_view.VulHotpatchDeactivateTaskCallback, VUL_TASK_HOTPATCH_DEACTIVATE_CALLBACK),
