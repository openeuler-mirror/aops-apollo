...
class TestCveMysqlProxy(unittest.TestCase):
    ...
    def test_get_overview(self):
        data = {"username": "admin"}
        expected_query_result = {"result": {"Critical": 0, "High": 1, "Medium": 1, "Low": 1, "Unknown": 1}}
    ...
    def test_get_cve_task_host(self):
        ...
        expected_query_result = {"result": {"qwfqwff5": [{"host_id": 2, "host_name": "host2", "host_ip": "127.0.0.2"}]}}
    ...
    def test_set_cve_status(self):
        ...
        status_1 = (
            self.cve_database.session.query(CveUserAssociation)
...
class TestCveProxy(unittest.TestCase):
    ...
    def test_get_cve_list_sort(self):
        data = {"sort": "host_num", "direction": "asc", "page": 1, "per_page": 10, "username": "admin", "filter": {}}
        expected_query_result = {
            "total_count": 3,
            "total_page": 1,
            "result": [
        ...
        data = {"sort": "host_num", "direction": "desc", "page": 1, "per_page": 10, "username": "admin", "filter": {}}
        expected_query_result = {
            "total_count": 3,
            "total_page": 1,
            "result": [
    ...
    def test_save_security_advisory(self):
        ...
        self.assertEqual(
            self.cve_database.save_security_advisory(filename, cve_rows, cve_pkg_rows, cve_pkg_docs), SUCCEED
        )

        cve_rows = [
            {"cve_id": None, "publish_time": "2021-1-2", "severity": "low", "cvss_score": "1.1", "reboot": False}
        ]
        self.assertEqual(
    ...
    def test_save_unaffected_cve(self):
        ...
        self.assertEqual(self.cve_database.save_unaffected_cve(filename, cve_rows, cve_pkg_rows, cve_pkg_docs), SUCCEED)

        cve_rows = [
            {"cve_id": None, "publish_time": "2021-1-2", "severity": "low", "cvss_score": "1.1", "reboot": False}
        ]
        self.assertEqual(
            self.cve_database.save_unaffected_cve(filename, cve_rows, cve_pkg_rows, cve_pkg_docs), DATABASE_INSERT_ERROR
        )
    ...
    def test_query_host_name_and_related_cves(self):
        ...
        self.assertEqual(
            self.cve_database.query_host_name_and_related_cves(host_id, username),
