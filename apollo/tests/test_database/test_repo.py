...
class TestRepoDatabase(unittest.TestCase):
    ...
    def test_query_repo(self):
        ...
        data = {"username": "admin", "repo_name_list": ["repo_not_exist1", "repo_not_exist2"]}
        ...
        expected_query_result = {
            "result": [{"repo_id": 2, "repo_name": "repo1", "repo_attr": "openEuler 21.09", "repo_data": "[update]"}]
        }
        ...
        expected_query_result = {
            "result": [
                {"repo_id": 2, "repo_name": "repo1", "repo_attr": "openEuler 21.09", "repo_data": "[update]"},
    ...
    def test_update_repo(self):
        ...
        data = {"username": "admin", "repo_name_list": ["repo1"]}
        expected_query_result = {
            "result": [{"repo_id": 2, "repo_name": "repo1", "repo_attr": "", "repo_data": "changed data"}]
        }
        self.assertEqual(self.repo_database.get_repo(data), (SUCCEED, expected_query_result))
