...
class TestHostDatabase(unittest.TestCase):
    ...
    def test_get_host_list_sort(self):
        data = {"sort": "cve_num", "direction": "desc", "page": 1, "per_page": 10, "username": "admin", "filter": {}}
        ...
        data = {"sort": "cve_num", "direction": "asc", "page": 1, "per_page": 10, "username": "admin", "filter": {}}
        expected_query_result = {
            "total_count": 3,
            "total_page": 1,
            "result": [
    ...
    def test_get_host_status(self):
        # get exist hosts
        data = {"username": "admin", "host_list": [1, 2]}
        expected_query_result = {"result": {1: "done", 2: "scanning"}}
        self.assertEqual(self.host_database.get_hosts_status(data), (SUCCEED, expected_query_result))

        # get partial exist hosts
        data = {"username": "admin", "host_list": [1, 4]}
        expected_query_result = {"result": {1: "done"}}
        self.assertEqual(self.host_database.get_hosts_status(data), (PARTIAL_SUCCEED, expected_query_result))

        # get not exist hosts
        data = {"username": "admin", "host_list": [4, 5]}
        self.assertEqual(self.host_database.get_hosts_status(data), (NO_DATA, {"result": {}}))

        # get all hosts
        data = {"username": "admin", "host_list": []}
        expected_query_result = {"result": {1: "done", 2: "scanning", 3: "scanning"}}
        self.assertEqual(self.host_database.get_hosts_status(data), (SUCCEED, expected_query_result))

    def test_get_host_info(self):
        # get exist host info
        data = {"username": "admin", "host_id": 1}
        expected_query_result = {
            "result": {
                'affected_cve_num': 1,
                'host_group': 'group1',
    ...
    def test_get_host_cve(self):
        ...
        data = {"host_id": 1, "username": "admin", "filter": {"cve_id": "ff3"}}
        expected_query_result = {
            "total_count": 1,
            "total_page": 1,
            "result": [
