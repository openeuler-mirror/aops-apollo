...
from vulcanus.restful.resp.state import SUCCEED, NO_DATA, DATABASE_INSERT_ERROR, PARTIAL_SUCCEED, SERVER_ERROR
...
class TestTaskMysqlFirst(unittest.TestCase):
    ...
    def test_get_scan_host_info(self):
        ...
        expected_result = [
            {"host_id": 1, "host_name": "host1", "host_ip": "127.0.0.1", "status": "done"},
            {"host_id": 2, "host_name": "host2", "host_ip": "127.0.0.2", "status": "scanning"},
            {"host_id": 3, "host_name": "host3", "host_ip": "127.0.0.2", "status": "scanning"},
        ]
        self.assertEqual(self.task_database.get_scan_host_info("admin", []), expected_result)

        # query one host's info
        expected_result = [{"host_id": 2, "host_name": "host2", "host_ip": "127.0.0.2", "status": "scanning"}]
    ...
    def test_get_task_list(self):
        data = {"sort": "create_time", "direction": "asc", "page": 1, "per_page": 10, "username": "admin", "filter": {}}
    ...
    def test_get_task_progress(self):
        ...
        expected_query_result = {
            "result": {
                "1111111111poiuytrewqasdfghjklmnb": {"succeed": 1, "fail": 0, "running": 1, "unknown": 1},
                "2222222222poiuytrewqasdfghjklmnb": {"succeed": 0, "fail": 1, "running": 0, "unknown": 0},
                "aaaaaaaaaapoiuytrewqasdfghjklmnb": {"succeed": 0, "fail": 1, "running": 1, "unknown": 0},
            }
        }
    ...
    def test_task_info_get(self):
        ...
        expected_result = {
            ...
            "total_count": 2,
            "result": [
                {"cve_id": "qwfqwff4", "package": "ansible,redis", "reboot": True, "host_num": 1, "status": "succeed"}
            ],
        }
        query_result = self.task_database.get_cve_task_info(data)
        sorted_pkg = sorted(query_result[1]["result"][0]["package"].split(','))
    ...
    def test_get_task_cve_status(self):
        data = {"username": "admin", "task_id": "1111111111poiuytrewqasdfghjklmnb", "cve_list": ["qwfqwff3"]}
        expected_result = {
            "result": {
                "qwfqwff3": [
                    {"host_id": 1, "host_name": "host1", "host_ip": "127.0.0.1", "status": "running"},
                    {"host_id": 2, "host_name": "host2", "host_ip": "127.0.0.2", "status": "unknown"},
                ]
            }
        }
        ...
        data = {"username": "admin", "task_id": "1111111111poiuytrewqasdfghjklmnb", "cve_list": []}
        expected_result = {
            "result": {
                "qwfqwff3": [
                    {"host_id": 1, "host_name": "host1", "host_ip": "127.0.0.1", "status": "running"},
                ...
                "qwfqwff4": [{"host_id": 3, "host_name": "host1", "host_ip": "127.0.0.1", "status": "succeed"}],
            }
        }
        query_result = self.task_database.get_task_cve_status(data)
        query_result[1]["result"]["qwfqwff3"].sort(key=lambda x: x["host_id"])
    ...
    def test_get_task_cve_progress(self):
        ...
        data = {"username": "admin", "task_id": "1111111111poiuytrewqasdfghjklmnb", "cve_list": ["not_exist_id"]}
    ...
    def test_update_cve_host_status(self):
        data = {"task_id": "1111111111poiuytrewqasdfghjklmnb", "cve_id": "qwfqwff3", "host_id": 1, "status": "fixed"}
        self.assertEqual(self.task_database.update_cve_status(**data), SUCCEED)

        data = {"task_id": "not_exist_id", "cve_id": "qwfqwff3", "host_id": 1, "status": "fixed"}
        self.assertEqual(self.task_database.update_cve_status(**data), NO_DATA)

    def test_get_running_task_form_task_cve_host(self):
        self.assertEqual(self.task_database.get_running_task_form_task_cve_host(), ['1111111111poiuytrewqasdfghjklmnb'])

    def test_get_running_task_form_task_host_repo(self):
        self.assertEqual(
            self.task_database.get_running_task_form_task_host_repo(), ["aaaaaaaaaapoiuytrewqasdfghjklmnb"]
        )
...
class TestTaskMysqlSecond(unittest.TestCase):
    ...
    def test_set_cve_progress(self):
        ...
        data = {"task_id": "1111111111poiuytrewqasdfghjklmnb", "cve_list": [], "method": "add"}
        progress_data = {"task_id": "1111111111poiuytrewqasdfghjklmnb", "username": "admin", "cve_list": []}
        ...
        data = {"task_id": "1111111111poiuytrewqasdfghjklmnb", "cve_list": [], "method": "fill"}
        self.assertEqual(self.task_database.set_cve_progress(**data), SUCCEED)
        expected_progress_result = {
            "result": {
        ...
        data = {"task_id": "1111111111poiuytrewqasdfghjklmnb", "cve_list": [], "method": "zero"}
        self.assertEqual(self.task_database.set_cve_progress(**data), SUCCEED)
        expected_progress_result = {
            "result": {
                "qwfqwff3": {"progress": 0, "status": "running"},
        ...
        data = {"task_id": "1111111111poiuytrewqasdfghjklmnb", "cve_list": ["qwfqwff3"], "method": "add"}
        self.assertEqual(self.task_database.set_cve_progress(**data), SUCCEED)
        expected_progress_result = {
            "result": {
                "qwfqwff3": {"progress": 1, "status": "running"},
        ...
        data = {"task_id": "1111111111poiuytrewqasdfghjklmnb", "cve_list": ["qwfqwff3"], "method": "wrong_method"}
        self.assertEqual(self.task_database.set_cve_progress(**data), SERVER_ERROR)

    def test_get_repo_task_info(self):
        data = {"username": "admin", "task_id": "aaaaaaaaaapoiuytrewqasdfghjklmnb", "page": 1, "per_page": 10}
        data2 = deepcopy(data)
        expected_result = {
            "result": [
                {"repo_name": "repo1", "host_id": 1, "host_name": "host1", "host_ip": "127.0.0.1", "status": "running"},
                {"repo_name": "repo2", "host_id": 2, "host_name": "host2", "host_ip": "127.0.0.2", "status": "fail"},
            ],
            "total_count": 2,
            "total_page": 1,
        }
    ...
    def test_set_repo_status(self):
        data = {"task_id": "aaaaaaaaaapoiuytrewqasdfghjklmnb", "host_list": [], "status": "running"}
        self.assertEqual(self.task_database.set_repo_status(**data), SUCCEED)
        expected_info = {
            "result": [
                {"repo_name": "repo1", "host_id": 1, "host_name": "host1", "host_ip": "127.0.0.1", "status": "running"},
                {"repo_name": "repo2", "host_id": 2, "host_name": "host2", "host_ip": "127.0.0.2", "status": "running"},
            ],
            "total_count": 2,
            "total_page": 1,
        }
        ...
        data = {"task_id": "aaaaaaaaaapoiuytrewqasdfghjklmnb", "host_list": [1], "status": "set"}
        self.assertEqual(self.task_database.set_repo_status(**data), SUCCEED)
        expected_info = {
            "result": [
                {"repo_name": "repo1", "host_id": 1, "host_name": "host1", "host_ip": "127.0.0.1", "status": "set"},
                {"repo_name": "repo2", "host_id": 2, "host_name": "host2", "host_ip": "127.0.0.2", "status": "running"},
            ],
            "total_count": 2,
            "total_page": 1,
...
class TestTaskEsProxy(unittest.TestCase):
    ...
    def test_get_repo_task_result(self):
        data = {"username": "admin", "task_id": "aaaaaaaaaapoiuytrewqasdfghjklmnb", "host_list": []}
        expected_result = {
            "task_id": "aaaaaaaaaapoiuytrewqasdfghjklmnb",
            "task_type": "repo",
...
class TestTaskProxy(unittest.TestCase):
    ...
    def test_gen_repo_task(self):
        ...
        expected_repo_task_info = {
            "result": [
                {"repo_name": "aaa repo", "host_id": 1, "host_name": "host1", "host_ip": "127.0.0.1", "status": "fail"},
                {"repo_name": "aaa repo", "host_id": 2, "host_name": "host2", "host_ip": "127.0.0.2", "status": "fail"},
            ],
            "total_count": 2,
            "total_page": 1,
        }
